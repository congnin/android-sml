...
object Named {
    ...
    const val OK_HTTP_CLIENT_NORMAL = "OK_HTTP_CLIENT_NORMAL"
    const val OK_HTTP_CLIENT_BYPASS_SSL = "OK_HTTP_CLIENT_BYPASS_SSL"
    const val RETROFIT_MOCK = "RETROFIT_MOCK"
    const val RETROFIT_KIOSK = "RETROFIT_KIOSK"
    const val RETROFIT_MOVIE = "RETROFIT_MOVIE"
