...
import vn.kingbee.utils.CommonUtils.Companion.txtPxToSp
...
internal class AttributeController(private val view: View, private val attrs: AttributeSet?) {
    ...
    private fun initAttr() {
        ...
        val iconMarginBottom =
            typedArray.getDimension(R.styleable.FitButton_fb_iconMarginBottom, 0f)
        val iconPosition =
            typedArray.getInt(R.styleable.FitButton_fb_iconPosition, IconPosition.CENTER.position)
        val iconVisibility =
            typedArray.getInt(R.styleable.FitButton_fb_iconVisibility, View.VISIBLE)
        ...
        val textPaddingStart =
            typedArray.getDimension(R.styleable.FitButton_fb_textPaddingStart, 0f)
        ...
        val textPaddingBottom =
            typedArray.getDimension(R.styleable.FitButton_fb_textPaddingBottom, 0f)
        ...
        val textVisibility =
            typedArray.getInt(R.styleable.FitButton_fb_textVisibility, View.VISIBLE)
        ...
        val rippleColor =
            typedArray.getColor(R.styleable.FitButton_fb_rippleColor, Color.parseColor("#42FFFFFF"))
        ...
        val borderColor =
            typedArray.getColor(R.styleable.FitButton_fb_borderColor, Color.TRANSPARENT)
