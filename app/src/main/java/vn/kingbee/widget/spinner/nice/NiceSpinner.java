...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.nice_arrow);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.NiceSpinner_dropDownListPaddingBottom, 0);
        horizontalAlignment = PopUpTextAlignment.Companion.fromId(
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.nice_arrow);
        setArrowDrawableOrHide(arrowDrawable);
    }
