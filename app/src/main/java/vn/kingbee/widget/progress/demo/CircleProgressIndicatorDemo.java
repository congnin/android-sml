package vn.kingbee.widget.progress.demo;

import vn.kingbee.widget.BaseActivity;
import vn.kingbee.widget.R;
import vn.kingbee.widget.progress.circularprogressindicator.CircularProgressIndicator;
import vn.kingbee.widget.progress.circularprogressindicator.ColorPickerDialogFragment;
...
public class CircleProgressIndicatorDemo extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actvity_circular_progress_indicator);
